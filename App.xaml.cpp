...
{	
	...
	Windows::ApplicationModel::Core::CoreApplicationViewTitleBar^ CoretitleBar = applicationView->TitleBar;
	...
	titleBar->ButtonHoverForegroundColor = Windows::UI::Colors::SeaGreen;
